...
The exact prefix and extended source members, thresholds, tolerances, per-frame
metrics, and report identity are content-addressed. The report opens no truth,
physical innovation, target outcome, or BayesianPhysTwin decision.
