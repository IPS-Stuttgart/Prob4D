...
WORKFLOW = ROOT / ".github/workflows/dot-rope-query-selective-heldout-gpuserver6000-v2.yml"
REQUEST = (
    "protocols/execution_requests/"
    "dot_rope_query_selective_heldout_gpuserver6000_v2.json"
)
...
def test_no_target_side_tuning_or_downstream_claim_expansion() -> None:
    _, text = _load()
    lowered = text.lower()
    for forbidden in (
        "optuna",
