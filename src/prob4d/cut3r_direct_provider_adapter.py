"""Import direct recurrent-online CUT3R XYZ point maps without depth reprojection."""
...
_ADAPTER_DOMAIN: Final = "prob4d.cut3r-direct-pointmap-provider-adapter.v1"
...
_RUN_DOMAIN: Final = "prob4d.cut3r-direct-pointmap-run.v1"
    ...
    with _canonical_direct_window(
        ...
        manifest = PredictionProviderManifestV1(
            ...
            metadata={
                ...
                "canonicalization_backend": "frame-streamed-direct-pointmap-memmap-v1",
