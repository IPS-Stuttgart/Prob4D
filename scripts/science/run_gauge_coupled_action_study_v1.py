...
SCHEMA = "prob4d.gauge-coupled-action-study"
SCHEMA_VERSION = 1
...
def build_result() -> dict[str, Any]:
    ...
    expected_harm_fraction = 2.0 / 3.0
    checks = {
        ...
        "point_completion_is_harmful_on_two_thirds_of_orbit": math.isclose(
            world["representative_completion_harm_fraction_vs_fallback"],
            expected_harm_fraction,
            rel_tol=0.0,
            abs_tol=2.0 / 131_072,
        ),
